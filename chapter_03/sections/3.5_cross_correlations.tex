...
If dark matter annihilates or decays into gamma rays, the resulting emission must trace the same large-scale structure \aure{check this section ref}(cf.\ Section~\ref{sec:1.1.3}) that is independently mapped by galaxy surveys.
...
The annihilation window function is strongly peaked at low redshifts, where the local dark matter density is highest and the clumping factor most effective.
...
This separation in redshift is what makes the cross-correlation with low-redshift galaxy catalogs particularly powerful for isolating a dark matter signal: the dark matter window function peaks precisely where the astrophysical foreground is most suppressed \cite{Fornengo:2013rga}.
