...
If dark matter annihilates or decays into gamma rays, the resulting emission must trace the same large-scale structure \aure{check this section ref}(cf.\ Section~\ref{sec:1.1.3}) mapped by galaxy surveys.
...
The variance of the cross-correlation spectrum, assuming Gaussian-distributed fluctuations, is given by \cite{Fornengo:2013rga}
\begin{equation}
...
The null hypothesis includes only astrophysical sources, while the alternative hypothesis adds a dark matter component parameterized by a single additional degree of freedom---the annihilation cross section $\langle \sigma v \rangle$ or, in the decay case, the lifetime $\tau_\chi$.
