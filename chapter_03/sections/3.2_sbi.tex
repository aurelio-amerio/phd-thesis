...
A further advantage is that SBI implicitly marginalizes over the vast latent space of the simulator, so the trained surrogate can retain information that hand-crafted summary statistics would discard; this makes SBI well suited to field-level inference.}
