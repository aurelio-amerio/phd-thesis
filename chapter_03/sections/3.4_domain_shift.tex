...
As a consequence, the spectral parameter distributions---flux, spectral index $\alpha$, and spectral curvature $\beta$---differ measurably between associated and unassociated sources (see Chapter~\ref{ch:5}).
