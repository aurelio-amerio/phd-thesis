...
Section~\ref{sec:3.3} covers the machine learning tools---convolutional neural networks and density estimation---used for regression and classification tasks on gamma-ray data.
