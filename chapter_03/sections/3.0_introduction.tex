...
We refer to these regimes as \emph{background-dominated}, and the term is worth defining at the outset.
The analyses of this thesis are rarely starved of photons: over more than fifteen years of observation, the Fermi-LAT has accumulated ample statistics across most of the sky.
What limits the sensitivity is instead the astrophysical emission itself --- components far brighter than any plausible dark matter signal, whose morphology and normalization we can model only imperfectly.
The challenge throughout is therefore systematic rather than statistical: the signal must be separated from backgrounds we cannot subtract exactly, and the methods of this chapter are built for that situation.
