...
The \KS test instead compares data and model at the level of their cumulative distributions: its \TS is the supremum of the absolute difference between the empirical cumulative distribution function of the data and the cumulative distribution predicted by the model.
...
\begin{itemize}
	...
	\item In Chapter~\ref{ch:8}, a $\Delta\chi^2$ \TS compares astrophysical-only and astrophysical-plus-DM hypotheses for the cross-correlation \gls{APS_}.
\end{itemize}
