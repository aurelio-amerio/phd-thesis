...
In the future, these results can be further improved with upcoming, deeper, and more densely sampled galaxy catalogs, such as those from the European Space Agency's {\it Euclid} satellite mission \cite{2024arXiv240513491E}, as well as by incorporating cross-correlations with other large-scale-structure tracers, such as weak lensing.
