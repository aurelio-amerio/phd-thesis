\subsection{Problem setting and statistical framework}
\label{sec:procedure}
%%%%
...
\begin{equation}
\mathcal{L}_0=\prod_{i=1}^{N_\textrm{pix}} \frac{\lambda_i^{k_i}e^{-{\lambda_i}}}{k_i!}\, .
\end{equation}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.6\textwidth]{chapter_07/paper_dnds_catalog/img/N_c.pdf}
