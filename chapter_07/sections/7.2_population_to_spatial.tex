...
The previous section showed that a fixed TS threshold discards sub-threshold sources whose aggregate properties --- including the $dN/dS$ --- are measurable from photon-count statistics~\cite{Malyshev:2011zi, Zechlin:2015wdz}.
