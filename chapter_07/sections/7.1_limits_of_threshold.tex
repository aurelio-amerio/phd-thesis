...
Genuine astrophysical sources exist below $\mathrm{TS} = 25$ --- the $dN/dS$ recovered in Chapter~\ref{ch:6} \blue{shows} this directly --- and their collective emission contributes to the high-latitude gamma-ray sky at a level that depends on the population model assumed.
