...
These spectral characterizations---in particular the flux, spectral index, and curvature from the log-parabola fits---form the feature space used in Chapter~\ref{ch:5} for a population-level study of unassociated sources, where quantification learning is applied to model the energy spectrum distribution of the unassociated population rather than classifying individual objects.
