...
\begin{figure}[t]
	...
	\caption{The 68\% containment radius of the Point Spread Function as a function of energy at normal incidence (solid) and at $60^\circ$ off-axis (dashed), for photons converting in the thin \textit{front} section of the tracker---the top 12 tracking planes interleaved with 0.03 radiation-length tungsten foils, chosen to minimise multiple scattering and provide the best angular resolution.
		Photons converting in the thick \textit{back} section (four planes with ${\sim}0.18$ radiation-length foils, trading resolution for effective area) have a PSF approximately twice as wide at 1~GeV.
