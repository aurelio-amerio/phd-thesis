...
An independent and increasingly powerful constraint comes from the cosmic microwave background: dark matter annihilation during and after recombination injects energy into the photon--baryon plasma, distorting the CMB temperature and polarisation anisotropies in a way that is tightly bounded by Planck data \cite{Cirelli:2024ssz}.
For $s$-wave annihilation, these bounds exclude the thermal relic cross-section for masses below $\sim 30$ GeV in most hadronic channels --- a limit that is largely independent of astrophysical modelling and therefore highly complementary to gamma-ray searches \cite{Cirelli:2024ssz}.
