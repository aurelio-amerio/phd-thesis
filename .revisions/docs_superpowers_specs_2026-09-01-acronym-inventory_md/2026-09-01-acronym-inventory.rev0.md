...
# Author decisions (record them here)

_To be filled in at the Task 1 Step 5 checkpoint; the commit is then amended._

| Flag | Decision | Date |
|---|---|---|
| F1 ML / NN / LSS | | |
| F2 single-use registered keys | | |
| F3 SCD vs SCDF_ | | |
| F4 dark matter / DM | | |
| F5 bare standalone LAT | | |
| F6 SNR dual meaning | | |
| F7 IC_ vs ICS_ | | |
| F8 AGN_ vs mAGN_ | | |
| F9 NFW | | |
...
| F13 2MASS / 2MRS | | |
| F14 gPCS | | |
| F15 mechanical casing table (a–n) | | |
| F16 digit/hyphen/space SHORTs | | |
| F17 single-use intros | | |
| F18 CR compounds | | |
| F19 CL | | |
| F20 isotropic diffuse gamma-ray background | | |
