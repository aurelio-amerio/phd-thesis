...
If dark matter annihilates or decays into gamma rays, the resulting emission must trace the same large-scale structure (cf.\ Section~\ref{sec:1.1.3}) that is independently mapped by galaxy surveys.
