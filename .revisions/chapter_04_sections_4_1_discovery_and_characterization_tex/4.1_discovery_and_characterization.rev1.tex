...
\blue{This morphological characterization requires a qualification that will matter for the rest of the chapter.
The approximate spherical symmetry established by these fits constrains the gross shape of the emission; it does not demonstrate that the excess is exactly spherical.
Later analyses argued that the boxy stellar bulge of the inner Galaxy describes the spatial distribution as well as, or better than, a spherically symmetric dark matter template (cf.\ Sections~\ref{sec:4.2.1} and~\ref{sec:4.3.2}).
Nor do these fits establish that the emission is truly diffuse: a population of point sources individually too faint to resolve would be absorbed by the same smooth template.
Whether the excess is exactly spherical, and whether it is smooth or granular, are precisely the discriminating questions taken up in Sections~\ref{sec:4.2} and~\ref{sec:4.3}.}
...
\blue{No known combination of astrophysical diffuse emission processes --- including cosmic-ray interactions with gas and radiation fields, emission from the Fermi Bubbles, or resolved catalogued point source populations --- reproduces the observed morphology~\cite{Daylan:2014rsa}.
In particular, the emission does not trace the gas, dust, or star-formation activity of the inner Galaxy, all of which are concentrated along the Galactic Plane; whether it instead traces the old stellar population of the bulge is the open question noted above.}
