...
The astrophysical components of the mixture model are the conditional PDFs $p({\bf x}|k)$ for the two astrophysical classes $k$, Galactic and extragalactic.
