...
The internal consistency of these measurements --- obtained with fundamentally different techniques, probing different physical environments --- constitutes one of the strongest arguments in favor of a DM interpretation in terms of new physics. 
...
If the visible mass --- concentrated in a central bulge --- was the main source of the gravitational potential, the rotation curve should decline as $v_c \propto r^{-1/2}$ beyond the luminous extent of the bulge, following the standard Keplerian falloff~\cite{Cirelli:2024ssz}.
...
Unlike the disk galaxies discussed above, stars in dSphs move on essentially random orbits, making these systems pressure-supported rather than rotationally supported.
...
Strong lensing in the dense cluster core produces highly distorted arcs and multiple images of background galaxies, while weak lensing measures the statistical shearing of background galaxy shapes over larger angular scales~\cite{Cirelli:2024ssz,Bullock:2017xww}.
Both regimes reconstruct the total mass distribution --- visible and dark --- from the geometry of light paths alone.

One of the most striking application of gravitational lensing is perhaps the Bullet Cluster (1E\,0657-558), analyzed by Clowe et al.~\cite{Clowe:2006eq}.
