...
\begin{figure}[t]
	...
	\caption{The imprint of dark matter on the \CMB.
		...
		\textit{Bottom right}: the same quantity computed in several different cosmological scenarios. \blue{The green line represents the best-fit $\Lambda$CDM model, while the red line shows the prediction for a universe without cold dark matter, which fails to reproduce the observed third acoustic peak.}
...
So far we have pointed out that the total matter density is $\Omega_m h^2 \approx 0.14$, while the \CMB independently constrains the baryon density to $\Omega_b h^2 \approx 0.022$~\cite{Aghanim:2018eyx} --- \blue{so the dark, supposedly non-baryonic component outweighs ordinary matter by roughly a factor of five}.
