...
This is an \emph{$s$-wave} process, meaning the cross section is independent of the relative velocity --- a noteworthy property, since it distinguishes whether or not the same $\sigmav$ that fixes the relic abundance also drives present-day annihilations in galactic halos.
