...
The appeal of this framework is that its phenomenology is largely governed by a single quantity, the velocity-averaged annihilation cross section $\langle\sigma v\rangle$, which fixes the cosmological relic abundance and --- under some assumptions --- the present-day annihilation rate in galactic halos.
