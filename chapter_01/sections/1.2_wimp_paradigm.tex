...
\blue{We survey the main candidate classes in order of increasing mass, reading Figure~\ref{fig:dm_mass_landscape} from left to right, before turning to two classifications that cut across it.}
...
\blue{Mass is only one way of organizing the candidate space. Two further distinctions cut across it and shape the phenomenology: how the relic abundance was produced, and whether dark matter is truly cold and collisionless. The first is illustrated by \emph{freeze-in}, in which \glspl{FIMP_} couple so weakly to the thermal bath that they never reach equilibrium~\cite{Hall:2009bx}.}
...
\blue{The second distinction concerns whether dark matter departs from the cold, collisionless scenario on which $\Lambda$CDM is built.}
