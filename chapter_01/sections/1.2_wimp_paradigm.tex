...
\aure{stopped here, need to re-read and edit this section}
...
\begin{figure}[t]
	...
	\caption{Comoving abundance $Y \equiv n_\chi/s$ as a function of the dimensionless inverse temperature $x \equiv M_\chi/T$.
		...
		The solid curves show the actual abundance for two values of the velocity-averaged annihilation cross section, illustrating that a larger annihilation cross section tracks equilibrium longer and freezes out at a smaller residual abundance.
