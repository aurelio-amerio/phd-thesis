...
Chemical equilibrium persists only as long as the annihilation rate $\Gamma = n_\chi \langle \sigma v_\mathrm{rel}\rangle$ remains above this value.}
...
\blue{The relic abundance is thus set to first approximation by how little a candidate annihilates --- by the velocity-averaged annihilation cross section $\langle \sigma v_\mathrm{rel}\rangle$ --- while the mass enters only at second order, logarithmically, through the temperature at which decoupling occurs.}
