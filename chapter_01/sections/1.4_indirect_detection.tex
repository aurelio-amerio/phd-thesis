...
\blue{The target list above is tailored to WIMP annihilation; alternative dark matter candidates reshuffle it.
...
For primordial black holes, the signature is instead \emph{Hawking evaporation}, which makes the diffuse MeV background and short gamma-ray bursts the relevant channels. \aure{add citation for PBH evaporation gamma-ray searches}
...
The relic abundance then fixes its mass: roughly $1$~TeV for a higgsino-like doublet and $3$~TeV for a wino-like triplet, beyond the comfortable reach of both Fermi-LAT and current ground-based telescopes.
