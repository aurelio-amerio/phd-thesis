...
This persistent ambiguity motivates the dedicated analysis in Chapter~\ref{ch:4}, which examines the millisecond pulsar hypothesis by constraining the pulsar luminosity function from globular cluster observations; the residual maps and spectrum of the excess are presented there, where its origin is examined in detail.
