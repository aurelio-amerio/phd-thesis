...
The target list above is tailored to \WIMP annihilation; alternative dark matter candidates change the most promising targets.
...
For galactic targets, however, neutrino constraints remain generally weaker than the corresponding gamma-ray bounds, owing to the experimental difficulty of detecting them; they become competitive only above roughly 1--10 TeV depending on the annihilation channel.

\textbf{Charged \glspl{CR_}} --- electrons, positrons, antiprotons, and heavier anti-nuclei --- suffer from a fundamental limitation: galactic magnetic fields randomize their arrival directions.
...
The original combined analysis of 15 \glspl{dSph_} with six years of data excluded the thermal relic cross-section for dark matter masses in the range $\sim 10$--$100$ GeV in the $b\bar{b}$ channel \cite{Fermi-LAT:2015att,2024PhRvD.109f3024M}; below $\sim 10$ GeV the Fermi-LAT effective area drops steeply and the constraints weaken.
...
The open territory is clearest at the highest masses.
...
Extracting any of these signals demands methods that go beyond simple signal-over-background thresholding.
