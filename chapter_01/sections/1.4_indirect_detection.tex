...
The development begins with the microphysics of annihilation and decay and the gamma-ray spectra they produce (\S\ref{sec:ann_decay}--\S\ref{sec:spectral_features}), then introduces the dark matter density profiles that determine how the signal varies across the sky (\S\ref{sec:density_profiles}).
