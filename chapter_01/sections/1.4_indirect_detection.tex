...
The annihilation and decay rates derived in Section~\ref{sec:ann_decay} depend directly on the dark matter density $\rho(r)$ --- and for annihilation, on $\rho(r)^2$.
...
The standard profiles come from cosmological $N$-body simulations which follow the gravitational collapse of billions of dark matter particles from primordial density perturbations to the present-day cosmic web \cite{Cirelli:2024ssz}.
These simulations show that the spherically averaged density $\rho(r)$ of collapsed halos follows a logarithmic slope $s(r) \equiv d\ln\rho / d\ln r$ that steepens with radius, converging to $s \approx -3$ in the outskirts \cite{Cirelli:2024ssz}.
