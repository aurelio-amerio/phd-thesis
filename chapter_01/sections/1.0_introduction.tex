...
Flat rotation curves in spiral galaxies~\cite{Rubin:1970zza,Persic:1995ru}, the dynamics and gravitational lensing of galaxy clusters~\cite{Clowe:2006eq}, and the detailed pattern of temperature anisotropies in the \CMB~\cite{Aghanim:2018eyx} all point consistently toward a dominant, non-luminous matter component.
