...
\section{\blue{Astrophysical Gamma-Ray Sources}}
\label{sec:astro_sky}
...
This spectral shape is \blue{basically} indistinguishable from the expected photon yield of a $\sim$50~GeV WIMP annihilating into $b\bar{b}$ quarks \cite{Cirelli:2024ssz} --- a topic we will extensively explore in Chapters~\ref{ch:4} and \ref{ch:5}.
