...
The Unresolved Gamma-Ray Background (UGRB) is the residual, almost isotropic emission that remains after subtracting the Galactic Diffuse Emission and all cataloged point sources \cite{Ackermann:2014usa, DGRB-review}. It is composed by the cummulative emission of all the currently unresolved gamma-ray sources, plus a residual truly diffuse isotropic background.
