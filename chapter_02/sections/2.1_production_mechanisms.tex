...
Starting from a set of assumptions about cosmic-ray source distributions (primarily \glspl{SNR_}), injection spectra, and diffusion parameters, GALPROP solves the steady-state diffusion-loss equation for all relevant cosmic-ray species as they propagate through the Galactic magnetic field and \ISM.
