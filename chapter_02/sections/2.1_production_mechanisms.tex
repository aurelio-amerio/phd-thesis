...
The behavior of this process depends critically on the energy $\epsilon$ of the target photon, through the dimensionless ratio $\epsilon E_e / m_e^2$. Up to a factor of order unity, this ratio is the photon energy in the electron rest frame, measured in units of the electron mass.
...
A further contribution comes from \emph{dark gas}---optically thick atomic hydrogen and CO-dark molecular hydrogen, which the standard 21~cm and CO surveys miss~\cite{Grenier:2005kbp}.
