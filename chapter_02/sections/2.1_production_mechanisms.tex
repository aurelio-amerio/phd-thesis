...
This universal spectral feature, known as the \emph{pion bump}, is the \blue{characteristic} spectral signature of hadronic cosmic-ray interactions with gas and has been observed in both supernova remnants and the Galactic Plane emission \cite{Fermi-LAT:2013iui}, see Figure~\ref{fig:pp_cross_section}.
...
This process \blue{is} the dominant cooling mechanism for cosmic-ray electrons in the MeV to GeV range in gas-dense environments such as the Galactic Plane, though it is broadly subdominant to hadronic emission in the same regions.
