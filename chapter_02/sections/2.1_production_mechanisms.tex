...
Astrophysical gamma rays from the Milky Way constitute the primary background in the search for dark matter signals.
Before cataloging individual point sources or attempting to extract information from the faint extragalactic emission, one must understand the physical processes that generate this intense foreground.
...
The Fermi collaboration applies precisely this procedure to produce the official Galactic interstellar emission model \texttt{gll\_iem\_v07}, which serves as the standard foreground template in Fermi-LAT analyses.
