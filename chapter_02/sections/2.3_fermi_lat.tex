...
This confusion directly limits the depth of point-source catalogs and motivates the use of statistical population methods---such as those developed in Chapters~\ref{ch:dnds} and~\ref{ch:dnds_catalog}---rather than standard source-by-source extraction.
