...
The most recent published incremental release, 4FGL-DR4, extends the dataset to 14 years and contains 7,194 sources \cite{Ballet:2023qzs}, with more recent data releases continuing to grow the catalog.
...
In the 4FGL-DR4, 4021 sources are identified or associated with extragalactic objects and 593 with Galactic source classes.
However, a substantial fraction---2577 sources---lacks any plausible multi-wavelength counterpart and remains unassociated \cite{Ballet:2023qzs}.
