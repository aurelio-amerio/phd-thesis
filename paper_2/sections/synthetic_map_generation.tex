...
Confronting with Eq. (\ref{eq:dnds:map}), the $F'_\textrm{iso}$ term denotes the sum of the purely isotropic contribution $F_\textrm{iso}$  and the contribution of sources, ${\cal S}$ term, below the 4FGL detection threshold.
