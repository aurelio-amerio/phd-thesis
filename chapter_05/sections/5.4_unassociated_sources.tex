...
\aure{need to review this phrase, it's imprecise}
\red{Second, classifiers trained on balanced datasets with comparable fractions of AGNs, pulsars, and simulated DM sources bear no relation to the actual class composition of the gamma-ray sky, where the DM prevalence may well be zero. This is likely to bias the estimation of any model trainined in such a way when applied to real world data.}
