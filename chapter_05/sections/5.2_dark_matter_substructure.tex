...
The primordial power spectrum, processed through the radiation-dominated epoch, retains more power on small spatial scales, so that smaller overdensities reach the nonlinear regime and gravitationally collapse before larger ones~\cite{Frenk:2012ph}.
The resulting bound objects---dark matter halos---then grow through the continuous accretion of diffuse matter and the merging of pre-existing smaller halos, a process known as hierarchical structure formation~\cite{Vogelsberger:2019ynw}.
