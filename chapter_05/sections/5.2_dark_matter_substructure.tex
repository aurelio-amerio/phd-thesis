...
\begin{figure}[t]
	...
	\caption{\blue{Dark matter substructure in a Milky Way-like halo from the Via Lactea II $N$-body simulation~\cite{Diemand:2008in}, illustrating the vast population of subhalos predicted by $\Lambda$CDM. The map shows the local dark matter density at $z=0$ within an 800~kpc cube.
