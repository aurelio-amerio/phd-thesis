...
In table \ref{tab:halos:settings} we summarize the analysis settings, which are similar to the standard event selection cuts used in the construction of gamma-ray source catalogs. 
