...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{sections/paper_dm_halos/img/efficiency/efficiency_bb_corrected.pdf}
...
\begin{equation}
    \lambda_{S_i, e,j} = \left[\int_{E_{min}^e}^{E_{max}^e} \phi_{0,i}\left(\frac{E}{E_0}\right)^{-\alpha_i - \beta_i\log(E/E_0)} dE\right] \cdot {\rm PSF_{i,j}^e} \cdot {\rm exposure_{j}^e} \cdot \frac{4\pi}{12 N_{\rm side}^2}.
    \label{eq:lambda}
\end{equation}
