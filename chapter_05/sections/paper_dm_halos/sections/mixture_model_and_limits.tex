...
We maximize eq.~(\ref{eq:L}) with the Expectation-Maximization (EM) algorithm, which is efficient for the cases of probabilistic mixture models~\cite{Saerens_2002}, see appendix~\ref{app:EM} for more details.
