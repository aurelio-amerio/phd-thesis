...
In this work, we construct for the first time a statistical model for the distribution of unassociated sources at latitudes $|b| > 10^\circ$.%
...
The model of J-factors used in this chapter is reviewed in section~\ref{sec:sim-jfactor}, while the simulation of gamma-ray sources corresponding to DM subhalos is presented in section~\ref{sec:DM_model}.
