...
% N-body cosmological simulations predict that galaxies, such as the Milky Way, are surrounded by a cloud of DM overdensities, which are called subhalos \cite{2001MNRAS.328..726S,2007ApJ...667..859D,Diemand:2008in,2009Sci...325..970K,2012AnP...524..507F,Zavala:2019gpq,2020NatRP...2...42V}.
...
% %refs:WIMP DM review
% \cite{Charles:2016pgz, 2017NatPh..13..224C, MiniReview_Gammaldi}.
...
In \blue{this work}, we construct for the first time a statistical model for the distribution of unassociated sources at latitudes $|b| > 10^\circ$.%
...
\blue{This chapter is organized as follows.}
...
The model of J-factors used in \blue{this chapter} is reviewed in section~\ref{sec:sim-jfactor}, while the simulation of gamma-ray sources corresponding to DM subhalos is presented in section~\ref{sec:DM_model}.
