...
\begin{itemize}
    \item Galactic \new{(dominated by millisecond pulsars at high latitudes~\cite{Fermi-LAT:2023zzt, 2020ApJS..247...33A, Fornasa:2015qua, Hooper:2024avz, Cholis:2014noa, Caraveo:2013lra})}: pulsars, binaries, star-forming regions, supernova remnants, pulsar wind nebulae, globular clusters, and novae;
    \item Extragalactic (\new{mostly AGNs~\cite{Fossati:1998zn, 2020ApJS..247...33A, Fornasa:2015qua, Dermer:2009zz, Ackermann_2015, Ajello:2015mfa, Lisanti:2016jub}}): blazars, quasars, starburst galaxies, normal galaxies, radio galaxies and radio sources, Seyfert galaxies, and non-blazar active galaxies.
\end{itemize}
%
%% aure: working here
%
...
We approximate the empirical distributions of associated and unassociated gamma-ray sources using kernel density estimation (KDE) with a Gaussian kernel \cite{Bishop:2006}. 
