...
\subsubsection{Subhalo J-factors from N-body simulations}
...
We adopt $J_{0.1}^{\Vmax}$ as our nominal case in this work, while we use the other J-factor values to compare with previous literature, e.g., in Calore et al. (2019)~\cite{2019Galax...7...90C} a $J_{0.1}^{M_{\rm sub}}$ model was used.
...
\subsubsection{Gamma-ray emission from dark matter subhalos}
\label{sec:DM_model}
