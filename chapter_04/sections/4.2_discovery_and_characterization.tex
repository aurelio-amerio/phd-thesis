% Section 4.2: Discovery and Characterization of the GCE
...
The behavior of the spectrum above 10~GeV would later become relevant to distinguishing between astrophysical and dark matter interpretations, as discussed in Section~\ref{sec:4.4}.
...
The radial fall-off of the emission is consistent with a generalized NFW profile with an inner slope in the range $\gamma \approx 1.1$--$1.3$~\cite{Daylan:2014rsa, Abazajian:2014fta, Calore:2014xka}, with different analyses finding specific best-fit values of $\gamma = 1.12 \pm 0.05$~\cite{Abazajian:2014fta}, $1.18$~\cite{Daylan:2014rsa}, and $1.26$--$1.28$ over larger regions of interest~\cite{Daylan:2014rsa}.
