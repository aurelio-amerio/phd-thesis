...
The evidence for point sources presented in Section~\ref{sec:4.2.2} rested largely on the Non-Poissonian Template Fitting (NPTF) framework, which exploits the difference in photon statistics between smooth (Poissonian) emission and populations of unresolved point sources.
