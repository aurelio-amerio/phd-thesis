...
How much fainter the inner-Galaxy pulsars could be in practice, however, and the actual age distribution of MSPs in the bulge remain open questions.
...
Building on an earlier study by Hooper and Linden~\cite{Hooper:2016rap}, in Amerio, Hooper, and Linden~\cite{Amerio:2024qor} we measured the gamma-ray luminosity function of MSPs across the Milky Way's globular cluster system, using the full Fermi-LAT dataset to date.
The luminosity function we obtain is consistent with that measured independently for MSPs \blue{in the Galactic plane}~\cite{Holst:2024fvb}:
