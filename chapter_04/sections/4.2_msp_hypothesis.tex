...
\blue{This discrepancy implies that the GCE can originate from MSPs only if those pulsars are systematically less luminous than any known MSP population---a requirement for which no compelling astrophysical mechanism has been established.}
...
\blue{In Section~\ref{sec:msp_paper}, we present a dedicated analysis that updates and extends this line of argument.}
