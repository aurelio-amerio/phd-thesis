...
\blue{It is important to note that these constraints are based on our current understanding of physical processes related to the formation and evolution of MSPs, both in the Galactic center and in other environments, and they are not derived from the GCE data itself. As such, an incomplete understanding of these processes could potentially weaken or alter the conclusions of the constraints.}
