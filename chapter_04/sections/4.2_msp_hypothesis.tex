...
How much fainter the inner-Galaxy pulsars could realistically be, however, remains an open question\blue{. The same models, which evolve these inherited pulsars forward from the populations observed in surviving clusters, find that the faded population can remain bright enough to account for a substantial fraction of the excess~\cite{Fragione:2017rsp,Ye:2022yxt}}.
