...
The leading alternative attributes the excess to a large population of unresolved \blue{millisecond pulsars} concentrated in the Galactic bulge.
...
\blue{Even granting such a bulge population, a more basic question remains: where would its millisecond pulsars come from?}
\blue{Millisecond pulsars are spun up by accretion in binary systems, and forming such binaries dynamically requires frequent close stellar encounters.}
...
\blue{There the Galactic tidal field pulls them apart, and their stars---millisecond pulsars included---are left behind in the bulge~\cite{Gnedin:2013cda,Brandt:2015ula,Fragione:2017rsp}.}
