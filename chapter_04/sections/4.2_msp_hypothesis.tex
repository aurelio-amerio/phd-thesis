...
\blue{If the bulge pulsars were born inside globular clusters and only later deposited in the field, then the clusters that survive today are the natural starting point for calibrating their luminosity function.}
