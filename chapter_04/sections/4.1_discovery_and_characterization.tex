...
The spatial morphology of the excess is approximately spherically symmetric.\footnote{\blue{The qualifier ``approximately'' carries much of the interpretive weight. An exactly spherical, truly diffuse emission is what dark matter annihilation predicts; a morphology tracing the stellar bulge, possibly built from unresolved millisecond pulsars, would point to an astrophysical origin. We return to this question in Sections~\ref{sec:4.2} and~\ref{sec:4.3}.}}
% Daylan et al.
