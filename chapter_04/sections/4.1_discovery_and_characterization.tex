...
\blue{First, the spectral shape of the excess was remarkably stable regardless of the adopted diffuse model, a robustness that we quantify together with the other established properties of the signal in Section~\ref{sec:4.1.3}.}
...
\blue{The fact that three independent observables---spectrum, morphology, and flux normalization---can be described by a simple, internally consistent dark matter model with parameters close to the thermal relic prediction has kept the GCE among the leading candidate signals in indirect detection for over a decade.}
