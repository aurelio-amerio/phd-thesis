...
Recovering the sub-threshold $dN/dS$ non-parametrically and with calibrated uncertainties opens several scientific directions.
...
Second, the recovered $dN/dS$ provides the empirical prior for the probabilistic source cataloging framework developed in Chapter~7: the flux distribution of sub-threshold sources directly determines the posterior probability that any given sky pixel contains a faint, as-yet-unresolved source.
...
This extension, while beyond the scope of the present work, represents a natural next step toward the dark matter cross-correlation searches pursued in Chapter~8.
