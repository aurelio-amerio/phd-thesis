...
First, a reliable measurement of the source-count distribution constrains the faint-end population of astrophysical emitters --- blazars, \glspl{SFG_}, and \glspl{MSP_} --- that collectively generate the bulk of the \UGRB.
...
The recovered distribution is broadly consistent with independent determinations in the literature. In particular, with the \gls{1pPDF_} and Compound Poisson Generator analyses of Zechlin, Cuoco et al.~\cite{Cuoco-1pdf} and the recent \SBI reconstruction of Eckner et al.~\cite{Eckner:2025waa}, which probe the same high-latitude sky with different \SBI techniques and a more in-deapth treatment of the galactic foreground model.
