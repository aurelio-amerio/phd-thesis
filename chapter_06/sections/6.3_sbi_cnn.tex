...
The network employs the heteroscedastic Gaussian cost function and concrete dropout regularisation to estimate both the $dN/dS$ and its uncertainties; the full formalism is presented in the paper body (Section~\ref{sec:bayesian-error}). A frequentist cross-check using the distribution of residuals on held-out validation maps confirms that the Bayesian error bands are well calibrated (Section~\ref{sec:bias}).
