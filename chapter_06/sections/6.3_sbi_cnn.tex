...
The 1pPDF formalism reviewed in the previous section \blue{is} the most developed analytical approach to sub-threshold source counts.
...
In practice, \blue{validating the method therefore carries a substantial computational cost}.
...
This approach preserves the area and information content of each pixel without spherical distortion, while \blue{retaining the speed of highly optimized standard convolutions}.
