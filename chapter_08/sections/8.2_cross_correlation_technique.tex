...
The angular cross-power spectrum $C_\ell^{\gamma g}$ introduced in Section~\ref{sec:3.5} measures how the gamma-ray intensity field and the galaxy number counts fluctuate together as a function of angular scale.
...
A non-zero DM contribution was allowed by the data but degenerate with the astrophysical components; the resulting upper limits on the annihilation cross section and decay lifetime were competitive with contemporary constraints from dwarf spheroidal galaxies and galaxy clusters, while arising from a genuinely independent observable --- the spatial coherence of DM emission with the cosmic web~\cite{Regis:2015zka}.
