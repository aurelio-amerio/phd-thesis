...
The angular dependence of $C_\ell^{\gamma g}$ can be decomposed into a 1-halo and a 2-halo contribution, following the halo-model formalism introduced in Section~\ref{sec:cross_correlations} and detailed in~\cite{Camera:2012cj,Fornasa:2015qua}.
...
Both catalogs are nominally all-sky; however, in the cross-correlation analysis the low-latitude region around the Galactic plane (approximately $|b| < 30^\circ$) is masked in the gamma-ray maps to suppress Galactic diffuse emission~\cite{Xia:2015wka,Fornasa:2015qua}. This masked region coincides with the region where dust obscuration already limits the completeness of infrared galaxy catalogs, making the masking consistent across both datasets.
...
In the local universe ($z \lesssim 0.1$), by contrast, even intrinsically faint blazars are close enough that their flux exceeds the point-source sensitivity of the Fermi-LAT~\cite{Fornasa:2015qua}; they are therefore individually detected, cataloged, and removed from the diffuse maps.
As a result, the unresolved blazar window function drops sharply at low redshift, and unresolved blazars in the volume probed by 2MASS and 2MRS are a negligible component of the UGRB at Fermi-LAT energies~\cite{Fornasa:2015qua,Cuoco:2015rfa}.
