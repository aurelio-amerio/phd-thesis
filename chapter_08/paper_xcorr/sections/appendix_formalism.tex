...
The general cross-correlation formalism---the angular power spectrum, the Limber approximation, the variance expressions, and the halo model decomposition---is introduced in Section~\ref{sec:cross_correlations}. This appendix provides the specific forms and modeling choices entering the CTAO analysis.

\subsection{Angular Power Spectra}

The angular power spectra for the $\gamma$-ray autocorrelation and for the cross-correlation between the unresolved $\gamma$-ray emission and a galaxy catalog $g$ can be expressed as (cf.\ Eq.~\ref{eq:limber_aps}) \cite{Camera:2012cj,Camera_2015,Fornengo:2013rga}
\begin{eqnarray}
    \label{eq:auto}
...
\begin{figure*}[t!]
    \centering
    \includegraphics[width=0.49\textwidth]{paper_xcorr/figures/new_analysis/PSF.pdf}
    \includegraphics[width=0.49\textwidth]{paper_xcorr/figures/new_analysis/beam_l.pdf}
...
\begin{figure}[t!]
\centering
\includegraphics[width=0.49\textwidth]{paper_xcorr/figures/new_analysis/N_CR.pdf}
\includegraphics[width=0.49\textwidth]{paper_xcorr/figures/new_analysis/exposure_CTA.pdf}
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=0.45\textwidth]{paper_xcorr/figures/new_analysis/N_gamma.pdf}
    \includegraphics[width=0.45\textwidth]{paper_xcorr/figures/new_analysis/N_CR_over_N_gamma.pdf}
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=0.9\textwidth]{paper_xcorr/figures/previous_analysis/integrated_flux_CR+PS_PLEC_rescaleto50h.pdf}
...
In the case of cross-correlations, the variance is instead given by (cf.\ Eq.~\ref{eq:variance_cross}) \cite{Camera:2012cj,Camera_2015,Fornengo:2013rga}
\begin{equation}
...
\paragraph{Gamma-ray astrophysical sources}
\label{app:Wastro}
...
\paragraph{Gamma-ray emission from dark matter}
\label{app:WDM}
...
For annihilating DM, the window function reads (cf.\ Eq.~\ref{eq:window_dm_ann})
%
 \be
...
Window functions for both DM and astrophysical sources are plotted in Figure~\ref{fig:zWindows} as a function of redshift for two different energies, and for $3\,\textrm{hrs}$ and $5\,\textrm{hrs}$ of observation time. It can be seen that the DM window always peaks at low $z$, while the astrophysical signal peaks at $z\sim 0.4-0.5$ at 50 GeV and  $z\sim 0.1-0.2$ at 1 TeV, with the horizon shrinking due to the effect of EBL $\gamma$-ray absorption.
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=0.45\textwidth]{paper_xcorr/figures/new_analysis/E2_mean_intensity.pdf}
...
Figures~\ \ref{fig:PS_tot}-\ref{fig:P1h_P2h} report the plots of the various 3D power spectra adopted in the analysis. Figures~\ref{fig:Cl_1TeV_binned}-\ref{fig:Cl_1TeV_cross} show a few samples of auto and cross-correlation APS as a function of the multipole $\ell$. It can be seen that auto APS of astrophysical sources is constant in $\ell$, since they are point-like, while the DM APS presents some structure due to the extension of the DM halos. Figure~\ref{fig:Cl_vs_E}, instead, shows the APS as a function of energy at a fixed multipole $\ell=100$. For comparison, the auto- and cross-correlation noise level is plotted, thus showing that the expected signal-to-noise ratio is typically low.



\begin{figure}[t!]
    \centering
    \includegraphics[width=0.45\textwidth]{paper_xcorr/figures/new_analysis/PS_auto_vs_k_tot.pdf}
    \includegraphics[width=0.45\textwidth]{paper_xcorr/figures/new_analysis/PS_cross_vs_k_tot.pdf}
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=0.45\textwidth]{paper_xcorr/figures/new_analysis/PS_auto_vs_k.pdf}
    \includegraphics[width=0.45\textwidth]{paper_xcorr/figures/new_analysis/PS_cross_vs_k.pdf}
    \caption{The same as Figure~\ref{fig:PS_tot} but with the 1-halo (dotted) and the 2-halo (solid) terms shown separately. }
    \label{fig:P1h_P2h}
\end{figure}
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=0.45\textwidth]{paper_xcorr/figures/new_analysis/Cl_1TeV_low_7bin_ell.pdf}
    \includegraphics[width=0.45\textwidth]{paper_xcorr/figures/new_analysis/Cl_1TeV_mid_7bin_ell.pdf}
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=0.45\textwidth]{paper_xcorr/figures/new_analysis/Cl_1TeV_low_7bin_ell_cross.pdf}
    \includegraphics[width=0.45\textwidth]{paper_xcorr/figures/new_analysis/Cl_1TeV_mid_7bin_ell_cross.pdf}
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=0.45\textwidth]{paper_xcorr/figures/new_analysis/Cl_vs_E_CTA_3h.pdf}
    \includegraphics[width=0.45\textwidth]{paper_xcorr/figures/new_analysis/Cl_vs_E_CTA_50h.pdf}
    \includegraphics[width=0.45\textwidth]{paper_xcorr/figures/new_analysis/Cl_vs_E_CTA_cross_3h.pdf}
    \includegraphics[width=0.45\textwidth]{paper_xcorr/figures/new_analysis/Cl_vs_E_CTA_cross_50h.pdf}
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=0.45\textwidth]{paper_xcorr/figures/new_analysis/CTA_sensitivity_3h.pdf}
    \includegraphics[width=0.45\textwidth]{paper_xcorr/figures/new_analysis/CTA_sensitivity_50h.pdf}
