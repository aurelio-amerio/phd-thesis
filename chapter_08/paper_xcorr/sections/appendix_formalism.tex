\subsection{Formalism and details of the modeling}
\label{app:model}
...
\subsubsection{Galaxies Halo Occupation Distribution}
...
\subsubsection{3D Power Spectra}
...
\subsubsection{Poisson anisotropy}
