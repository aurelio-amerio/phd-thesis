...
infile = open('bandsforplot-case2.out', 'r')
for line in infile.readlines():
        params = line.split()
...
plt.text(1.6E-4, 8.0E35, r'$\langle N_{\rm MSP} \rangle = 15 \, \Gamma_e^{\,0.7}$',rotation=0,color='black',fontsize=17)
...
fig.savefig('case2-dataplot.pdf')
